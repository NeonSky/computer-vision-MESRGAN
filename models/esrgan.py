...
class RDB(nn.Module):
    ...
    def __init__(self, n_filters=64, growth_channel=32):
        super().__init__()
...
class RRDB(nn.Module):
    ...
    def __init__(self, n_blocks):
        ...
        self.residual_scaling_param = 0.2
        self.rdbs = nn.Sequential(*[RDB() for _ in range(n_blocks)])
...
class Generator(nn.Module):
    ...
    def __init__(self, n_channels=3, n_rrdbs=16, n_upscales=2):
        super().__init__()
